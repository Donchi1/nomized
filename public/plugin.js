  ...
  ;(b.defaults = {
    ...
    (b.methods = {
      getVars: function (c) {
        ...
        return d.breakpoints && (d = b.methods.getResponsiveVars(d)), d
      },
      getResponsiveVars: function (b) {
      ...
      selfClose: function (c, d) {
        a(document).on('click', function (e) {
          ...
          a(e.target).closest(c).length ||
            ((f = c.filter('.' + d.openClass)),
            null !== d.stayOpen &&
              (f = f.not(b.methods.getStayOpen(c, d.stayOpen))),
            f.length && c.close(f))
        })
      },
      hash: function (b, c) {
      ...
      return (
          ...
          return (
            ...
            c.each(function () {
              ...
              b.methods.animation(g, f, d.openSpeed, function () {
                c.addClass(d.openClass),
                  f.css('overflow', ''),
                  e && 'function' == typeof e && e(),
                  d.onOpen && 'function' == typeof d.onOpen && d.onOpen(c)
              })
            }),
            d
          )
          ...
          return (
            ...
            c.each(function () {
              ...
              b.methods.animation(g, f, d.closeSpeed, function () {
                c.removeClass(d.openClass),
                  f.css('overflow', ''),
                  e && 'function' == typeof e && e(),
                  d.onClose && 'function' == typeof d.onClose && d.onClose(c)
              })
            }),
            d
          )
        ...
        (this.click = function (a) {
          ...
          return (
            c.openSingle &&
              (null !== c.stayOpen
                ? d.close(d.not(a).not(b.methods.getStayOpen(d, c.stayOpen)))
                : d.close(d.not(a))),
            a.hasClass(c.openClass)
              ? d.close(a)
              : d.open(a, function () {
                  c.scroll && d.scroll(a)
                }),
        ...
        this.each(function (e, f) {
          ...
          g.data('beefup') ||
            (g.data('beefup', h),
            h.breakpoints && (h = b.methods.getResponsiveVars(h)),
            null !== h.stayOpen &&
              g.is(b.methods.getStayOpen(d, h.stayOpen)) &&
              g.addClass(h.openClass),
            g
              .not('.' + h.openClass)
              .find(h.content + ':first')
              .hide(),
            ...
            0 === e &&
              (h.hash && b.methods.hash(d, h),
              h.selfClose && b.methods.selfClose(d, h)))
        })
      )
    })
})(jQuery)
